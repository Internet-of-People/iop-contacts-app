...
import org.libertaria.world.forum.InvalidUserParametersException;
import org.libertaria.world.forum.discourge.com.wareninja.opensource.discourse.utils.StringRequestParameter;
import org.libertaria.world.global.exceptions.ConnectionRefusedException;
import org.libertaria.world.governance.propose.Beneficiary;
import org.libertaria.world.governance.propose.Proposal;
import org.libertaria.world.governance.propose.ProposalTransactionBuilder;
...
import static org.libertaria.world.forum.wrapper.ResponseMessageConstants.ADMIN_NOTIFICATION;
import static org.libertaria.world.forum.wrapper.ResponseMessageConstants.ADMIN_NOTIFICATION_MESSAGE;
import static org.libertaria.world.forum.wrapper.ResponseMessageConstants.ADMIN_NOTIFICATION_TYPE;
import static org.libertaria.world.forum.wrapper.ResponseMessageConstants.BEST_CHAIN_HEIGHT_HASH;
import static org.libertaria.world.forum.wrapper.ResponseMessageConstants.IOP_RATE_USD;
import static org.libertaria.world.forum.wrapper.ResponseMessageConstants.USER_ERROR_STR;
import static org.libertaria.world.utils.StreamsUtils.convertInputStreamToString;
...
//            JSONObject jsonObject = new JSONObject(result);
            ...
            if (httpResponse.getStatusLine().getStatusCode()==200){
                ...
                apiKey = jsonObject.get(org.libertaria.world.forum.wrapper.ResponseMessageConstants.API_KEY).getAsString();
                return apiKey;
            }else {
    ...
    public boolean requestCoins(String address){
        ...
        List<org.libertaria.world.forum.discourge.com.wareninja.opensource.discourse.utils.RequestParameter> requestParams = new ArrayList<>();
        ...
        try {
            ...
            int i = 0;
            for (org.libertaria.world.forum.discourge.com.wareninja.opensource.discourse.utils.RequestParameter requestParam: requestParams) {
...
//                requestProposalsResponse.bestChainHash = jsonObject.get(BEST_CHAIN_HEIGHT_HASH).getAsString();
    ...
    private void checkAdminNotification(JsonObject jsonObject) throws AdminNotificationException {
        JsonElement json;
        if ((json = jsonObject.get(org.libertaria.world.forum.wrapper.ResponseMessageConstants.ADMIN_NOTIFICATION))!=null) {
            if (!json.isJsonNull()){
