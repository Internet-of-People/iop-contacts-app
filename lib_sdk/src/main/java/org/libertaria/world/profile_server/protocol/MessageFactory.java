package org.libertaria.world.profile_server.protocol;

import com.google.protobuf.ByteString;

import org.bitcoinj.core.Sha256Hash;
import org.libertaria.world.profile_server.Signer;
import org.libertaria.world.profile_server.protocol.*;
...
public class MessageFactory {
    ...
    public static IopProfileServer.Message buildInvalidMessageHeaderResponse(){
        return buildMessage(org.libertaria.world.profile_server.protocol.IopShared.Status.ERROR_PROTOCOL_VIOLATION);
    }
    ...
    public static IopProfileServer.Message buildVersionNotSupportResponse() {
        ...
        return buildMessage(org.libertaria.world.profile_server.protocol.IopShared.Status.ERROR_UNSUPPORTED);
    }
    ...
    private static IopProfileServer.Message buildMessage(org.libertaria.world.profile_server.protocol.IopShared.Status responseStatus){
