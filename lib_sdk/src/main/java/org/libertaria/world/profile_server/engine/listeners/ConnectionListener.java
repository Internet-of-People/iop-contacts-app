...
public interface ConnectionListener {
    ...
    void onConnectionLost(org.libertaria.world.profile_server.model.Profile localProfile, String psHost, IopProfileServer.ServerRoleType portType,String callId ,String tokenId);
}
