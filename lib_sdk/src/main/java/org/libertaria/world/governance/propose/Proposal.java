...
import org.libertaria.world.global.exceptions.NotValidParametersException;
...
import static org.libertaria.world.global.utils.Preconditions.checkEquals;
import static org.libertaria.world.governance.ProposalForum.TAG_BENEFICIARY_ADDRESS;
import static org.libertaria.world.governance.ProposalForum.TAG_BENEFICIARY_VALUE;
import static org.libertaria.world.governance.ProposalForum.TAG_BLOCK_REWARD;
import static org.libertaria.world.governance.ProposalForum.TAG_BODY;
import static org.libertaria.world.governance.ProposalForum.TAG_END_BLOCK;
import static org.libertaria.world.governance.ProposalForum.TAG_START_BLOCK;
import static org.libertaria.world.governance.ProposalForum.TAG_SUBTITLE;
import static org.libertaria.world.governance.ProposalForum.TAG_TITLE;
...
public class Proposal implements Serializable {
    ...
    public static Proposal buildFromBody(String formatedBody) {
        ...
        int startBlock = org.libertaria.world.utils.StringUtils.unformatStringToIntNumber(getTagValue(formatedBody,PATTERN_TAG_START_BLOCK,1));
        proposal.setVotingPeriod(startBlock);
        int endBlock = org.libertaria.world.utils.StringUtils.unformatStringToIntNumber(getTagValue(formatedBody,PATTERN_TAG_END_BLOCK,2));
        proposal.setEndBlock(endBlock);
        long blockReward = org.libertaria.world.utils.StringUtils.unformatStringToLongNumber(getTagValue(formatedBody,PATTERN_TAG_BLOCK_REWARD,3));
    ...
    public static List<Beneficiary> buildBeneficiaries(String formatedBody){
        ...
        if (!list.isEmpty()){
            for (int i=4;i<list.size();i=i+2){
                long amount = org.libertaria.world.utils.StringUtils.unformatStringToLongNumber(list.get(i+1));
...
//        stringBuilder.append(appendFieldsWithName("forumLink",forumLink));
    ...
    public String toForumBody(String header,String moreData){
        ...
        String startBlockStr = org.libertaria.world.utils.StringUtils.formatNumberToString(votingPeriod);
        String endBlockStr = org.libertaria.world.utils.StringUtils.formatNumberToString(endBlock);
        String blockRewardStr = org.libertaria.world.utils.StringUtils.formatNumberToString(blockReward);
        ...
        for (int i = 0; i < beneficiaries.size(); i++) {
            ...
            String amountStr = org.libertaria.world.utils.StringUtils.formatNumberToString(beneficiary.getAmount());
...
//            stringBuilder.append("Beneficiary"+(i+1)+": Address: <address>"+replaceTag(TAG_BENEFICIARY_ADDRESS,beneficiary.getAddress())+"</address>   value: "+replaceTag(TAG_BENEFICIARY_VALUE, String.valueOf(beneficiary.getAmount()))+" IoPs");
    ...
    public static void validateVotingPeriod(int votingPeriod){
        ...
        if (votingPeriod < VOTING_PERIOD_MIN_VALUE) throw new IllegalArgumentException("Voting Period must be higher than "+ org.libertaria.world.utils.StringUtils.formatNumberToString(VOTING_PERIOD_MIN_VALUE) + " blocks");
    }
