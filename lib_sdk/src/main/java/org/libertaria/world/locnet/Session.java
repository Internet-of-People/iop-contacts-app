...
public class Session {
    ...
    Session(org.libertaria.world.locnet.NodeInfo node) throws IOException {
...
//        System.out.println("Connecting node " + node);
    ...
    public List<org.libertaria.world.locnet.NodeInfo> getNeighbourhood() throws IOException {
        ...
        if (response.getClientResponseTypeCase() != IopLocNet.ClientResponse.ClientResponseTypeCase.GET_NEIGHBOUR_NODES) {
    ...
    public List<org.libertaria.world.locnet.NodeInfo> getClosestNodes(GpsLocation location,
        ...
        if (response.getClientResponseTypeCase() != IopLocNet.ClientResponse.ClientResponseTypeCase.GET_CLOSEST_NODES) {
            throw new IllegalStateException("Received unexpected response type");
        }
    ...
    public List<org.libertaria.world.locnet.NodeInfo> exploreNodes(GpsLocation location,
        ...
        if (response.getClientResponseTypeCase() != IopLocNet.ClientResponse.ClientResponseTypeCase.EXPLORE_NODES) {
            throw new IllegalStateException("Received unexpected response type");
        }
