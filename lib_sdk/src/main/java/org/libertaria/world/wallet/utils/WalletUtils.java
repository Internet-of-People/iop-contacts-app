...
//	}
	 ...
	 * @return
	 */
	public static List<TransactionOutput> getInputsForAmount(Wallet wallet,Coin totalAmount,List<TransactionOutput> unspent,List<TransactionOutput> usedOutputs,OutputsLockedListener outputsLockedListener) throws org.libertaria.world.wallet.exceptions.InsuficientBalanceException {
		...
		if (!inputsSatisfiedContractValue)
			throw new org.libertaria.world.wallet.exceptions.InsuficientBalanceException("Inputs not satisfied vote value");
