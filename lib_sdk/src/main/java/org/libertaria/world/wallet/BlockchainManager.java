...
//            peerGroup.removeConnectedEventListener(peerConnectivityListener);
    ...
    public void check(Set<org.libertaria.world.wallet.utils.BlockchainState.Impediment> impediments, PeerConnectedEventListener peerConnectivityListener, PeerDisconnectedEventListener peerDisconnectedEventListener , PeerDataEventListener blockchainDownloadListener){
        synchronized (this) {
                ...
                if (conf.getNetworkParams().equals(RegTestParams.get())) {
                    peerGroup.addPeerDiscovery(new PeerDiscovery() {
                        ...
                        public InetSocketAddress[] getPeers(long services, long timeoutValue, TimeUnit timeUnit) throws PeerDiscoveryException {
                            return org.libertaria.world.wallet.utils.RegtestUtil.getPeersToConnect(conf.getNetworkParams(),conf.getNode());
                        }
...
//        broadcastBlockchainState();
    ...
    private void notifyBlockchainStateOff(Set<org.libertaria.world.wallet.utils.BlockchainState.Impediment> impediments) {
        for (BlockchainManagerListener blockchainManagerListener : blockchainManagerListeners) {
    ...
    public org.libertaria.world.wallet.utils.BlockchainState getBlockchainState(Set<org.libertaria.world.wallet.utils.BlockchainState.Impediment> impediments)
    {
        ...
        return new org.libertaria.world.wallet.utils.BlockchainState(bestChainDate, bestChainHeight, replaying, impediments);
    }
